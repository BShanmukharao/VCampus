...
import './TransferCertificateAndRecoedSheet.css'

function TransferCertificateAndRecoedSheet() {

    return (
        <div className='bonafide-cum-study-certificate-bg-container'>
            <form className='bonafide-cum-study-certificate-form-bg-container'>
                <h1 className='bonafide-cum-study-certificate-main-heading mb-0'>TRANSFER CERTIFICATE</h1>
...
export default TransferCertificateAndRecoedSheet;
