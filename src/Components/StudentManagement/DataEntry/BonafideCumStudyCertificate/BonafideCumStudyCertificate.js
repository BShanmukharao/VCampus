...
import './BonafideCumStudyCertificate.css'

function BonafideCumStudyCertificate() {

    return (
        <div className='bonafide-cum-study-certificate-bg-container'>
            <form className='bonafide-cum-study-certificate-form-bg-container'>
                <h1 className='bonafide-cum-study-certificate-main-heading mb-0'>BONAFIDE CERTIFICATE</h1>
...
export default BonafideCumStudyCertificate;
