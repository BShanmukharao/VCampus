...
import './ApplicationRegistrationFee.css'
    ...
    useEffect(() => {
        ...
        setTodayDate(formattedDate)
            ...
            const requestOptions = {
                ...
                body: JSON.stringify({ 'key': 'ASCTEST' })*/
            };
            const data = fetch('https://visualcampus.in/API/api/TeacherController/GETListAllClass?Clientid=1&Branchid=1&EmpId=1')
            console.log(data)
