                ...
                <div className='container-fluid pt-2'>
                    <div className='row'>
                        ...
                        <div className='col-xs-12 col-sm-6 col-md-4 col-lg-3 col-xl-3 col-xxl-2 label-and-input'>
                            ...
                            <input type='checkbox' className='checkbox-class' required onInvalid={(e) => (e.target.setCustomValidity('Date of birth is required'))} onInput={(e) => (e.target.setCustomValidity(''))} />
                        </div>
                    </div>
