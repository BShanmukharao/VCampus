...
import './SubjectWiseFaculties.css'

function SubjectWiseFaculties() {

    return (
        <div className='class-faculties-list-bg-container'>
            <form className='class-faculties-list-form-bg-container'>
                <h1 className='class-faculties-list-main-heading mb-0'>RECORD FACULTYS</h1>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-xs-12 col-sm-6 col-md-4 col-lg-3 col-xl-3 col-xxl-2 mt-2'>
                            ...
                            <div className="radio-with-label">
                                ...
                                <label htmlFor="DMDAL" className="radio-button-label">EDIT</label>
                            </div>
                            <div className="radio-with-label">
                                <input type='radio' id="DMDSS" name="DMDSS" className="radio-button-class" />
                                <label htmlFor="DMDSS" className="radio-button-label">RE-CREATE</label>
                            </div>
                        </div>
                    </div>
...
export default SubjectWiseFaculties;
