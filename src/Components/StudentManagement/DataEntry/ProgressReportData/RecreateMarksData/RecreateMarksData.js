...
import './RecreateMarksData.css'

function RecreateMarksData() {

    return (
        <div className='recreate-marks-data-bg-container'>
            <form className='recreate-marks-data-form-bg-container'>
                <h1 className='recreate-marks-data-main-heading mb-0'>RECREATE MARKS DATA</h1>
                <div className='container-fluid pt-2'>
                    <div className='row'>
                        ...
                        <div className='col-xs-12 col-sm-6 col-md-4 col-lg-3 col-xl-3 col-xxl-2 mt-2'>
                            ...
                            <div className="radio-with-label">
                                <input type='radio' id="DMDAL" name="DMDSS" className="radio-button-class" />
...
export default RecreateMarksData;
