...
import './JournalVochers.css'

function JournalVochers() {
    ...
    return (
        <>
            <div className='define-vehicles-for-new-students-bg-container'>
                <h1 className='define-vehicles-for-new-students-main-heading mb-0'>JOURNAL VOCHERS</h1>
